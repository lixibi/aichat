...
const bn: PartialLocaleType = {
  ...
  Settings: {
    ...
    Danger: {
      ...
      ClearChat: {
        Title: "চ্যাট ডেটা সাফ করুন",
        SubTitle: "সমস্ত চ্যাট ডেটা সাফ করুন (সেটিংস বাদে)",
        Action: "চ্যাট ডেটা সাফ করুন",
        Confirm: "আপনি কি সমস্ত চ্যাট ডেটা সাফ করতে চান?",
      },
      ClearALL: {
        Title: "সমস্ত ডেটা এবং সেটিংস সাফ করুন",
        SubTitle:
          "সমস্ত চ্যাট ডেটা এবং সেটিংস মুছে ফেলুন, প্রাথমিক অবস্থায় ফিরে যান",
        Action: "সবকিছু সাফ করুন",
        Confirm: "আপনি কি সমস্ত চ্যাট ডেটা এবং সেটিংস মুছতে চান?",
      },
    },
    Lang: {
